...
const {idExist, smsConfirm,fetchRole,rolesAllowed,getQueryUrl} = require('./../handlers');
...
app.post('/sendSms', async (req,res) => {
    try{
        ...
        let text = `שלום ${user.first_name}, קוד האימות שלך הוא: ${random}`
        await smsConfirm(user.phone, text);
